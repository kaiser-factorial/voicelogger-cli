...
async function wizardProviderStep(): Promise<Provider> {
  ...
  const providers: Provider[] = ["anthropic", "openrouter", "ollama"];
...
async function wizardKeyStep(provider: Provider): Promise<void> {
  if (provider === "ollama") {
