...
export function parseCleanMode(value: string | undefined): CleanMode | undefined {
 ...
 */
export function resolveAutoCleanMode(args: string[], fallback: CleanMode = "auto"): CleanMode {
  if (args.includes("--no-clean")) return "off";
